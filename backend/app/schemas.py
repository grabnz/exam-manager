...
SCORE_FIELDS = [
    "prod_dictee_c4",
    "prod_ecriture_c2", "prod_ecriture_c7", "prod_ecriture_bonus",
    "prod_production_c1", "prod_production_c3", "prod_production_c5", "prod_production_c6", "prod_production_bonus",
    "lect_vocale_c1", "lect_vocale_c5", "lect_vocale_bonus",
    "lect_comp_c2", "lect_comp_c3", "lect_comp_c4", "lect_comp_c6", "lect_comp_bonus",
    "com_rec_c1", "com_rec_c2", "com_rec_c3", "com_rec_c4", "com_rec_bonus",
    "com_oral_c1", "com_oral_c2", "com_oral_c3", "com_oral_c4", "com_oral_c5", "com_oral_c6", "com_oral_bonus",
]
